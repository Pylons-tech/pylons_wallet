    ...
    private val tradeListJson = """
{
    ...
    fun getTradeList() {
        val expected = listOf(
                ...
                Trade("0.0.1", "cosmos1mkk2q586y5pz263u5v8dv59723u58059ytprs961818c70-3c1c-48f6-9559-085b577af09e", listOf(CoinInput("loudcoin", 4000)), listOf(), listOf(CoinOutput("pylon", 330)), listOf(), "created by loud game", "cosmos1mkk2q586y5pz263u5v8dv59723u58059ytprs9", "cosmos1842mp69ydaljedffpnatcjtl7ns23vf6mzptfs", false, true
                ),
                Trade("0.0.1", "cosmos1mkk2q586y5pz263u5v8dv59723u58059ytprs9ceed66cd-5fe2-480e-a4e7-64c728423b77", listOf(CoinInput("pylon", 50001)), listOf(), listOf(CoinOutput("loudcoin", 3000)), listOf(), "created by loud game", "cosmos1mkk2q586y5pz263u5v8dv59723u58059ytprs9", "", false, false
                ),
                Trade("0.0.1", "cosmos1ng9ehpmjc4mk8s3e7jxfwa2t4rtkhyhj58ngrn37ce48ae-4527-487d-b981-e40a63a18e5f", listOf(CoinInput("loudcoin", 332)), listOf(), listOf(CoinOutput("pylon", 33)), listOf(), "created by loud game", "cosmos1ng9ehpmjc4mk8s3e7jxfwa2t4rtkhyhj58ngrn", "", false, false
                ))
