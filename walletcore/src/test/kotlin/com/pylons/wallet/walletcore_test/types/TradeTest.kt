    ...
    private val tradeListJson = """
{
    ...
    fun getTradeList() {
        val expected = listOf(
                Trade("cosmos16hwvr9u0zrwu2smaefylq2t8nsfz3g6ytd9e6050971e5d-7349-43a1-ab78-8a5e11a45988", listOf(), listOf(ItemInput(listOf(DoubleInputParam("XP", "1", "1000000")), listOf(LongInputParam("level", 1, 2)), listOf(StringInputParam("Name", "LionBaby")))), listOf(CoinOutput("pylon", "pylon", 444)), listOf(), "character buy request created by loud game", "cosmos16hwvr9u0zrwu2smaefylq2t8nsfz3g6ytd9e60", "cosmos1ng9ehpmjc4mk8s3e7jxfwa2t4rtkhyhj58ngrn", false, true
                ),
                ...
                Trade("cosmos1842mp69ydaljedffpnatcjtl7ns23vf6mzptfs7b0fc361-5ce0-4cfb-9173-039e84c89124", listOf(), listOf(ItemInput(listOf(), listOf(LongInputParam("level", 1, 1)), listOf(StringInputParam("Name", "Wooden sword")))), listOf(CoinOutput("pylon", "pylon",333)), listOf(), "sword buy request created by loud game", "cosmos1842mp69ydaljedffpnatcjtl7ns23vf6mzptfs", "cosmos16hwvr9u0zrwu2smaefylq2t8nsfz3g6ytd9e60", false, true
                ),
                ...
                Trade("cosmos1h7pam0zqguvrnkqyf4hlwj0jg3xpwkq0u0uxgl3da7b0cc-e79a-4e8b-90f0-3ce3032e691e", listOf(), listOf(ItemInput(listOf(), listOf(), listOf(StringInputParam("Name", "Trading Knife v3")))), listOf(CoinOutput("eugencoin", "eugencoin",200)), listOf(), "item to coin trading", "cosmos1h7pam0zqguvrnkqyf4hlwj0jg3xpwkq0u0uxgl", "cosmos1yafkzzx9lygqvy8hxx9l9e2cw7ct5rp3ly03ep", false, true
                ),
                ...
                Trade("cosmos1mkk2q586y5pz263u5v8dv59723u58059ytprs961818c70-3c1c-48f6-9559-085b577af09e", listOf(CoinInput("loudcoin", 4000)), listOf(), listOf(CoinOutput("pylon", "pylon",330)), listOf(), "created by loud game", "cosmos1mkk2q586y5pz263u5v8dv59723u58059ytprs9", "cosmos1842mp69ydaljedffpnatcjtl7ns23vf6mzptfs", false, true
                ),
                Trade("cosmos1mkk2q586y5pz263u5v8dv59723u58059ytprs9ceed66cd-5fe2-480e-a4e7-64c728423b77", listOf(CoinInput("pylon", 50001)), listOf(), listOf(CoinOutput("loudcoin", "loudcoin",3000)), listOf(), "created by loud game", "cosmos1mkk2q586y5pz263u5v8dv59723u58059ytprs9", "", false, false
                ),
                Trade("cosmos1ng9ehpmjc4mk8s3e7jxfwa2t4rtkhyhj58ngrn37ce48ae-4527-487d-b981-e40a63a18e5f", listOf(CoinInput("loudcoin", 332)), listOf(), listOf(CoinOutput("pylon", "pylon",33)), listOf(), "created by loud game", "cosmos1ng9ehpmjc4mk8s3e7jxfwa2t4rtkhyhj58ngrn", "", false, false
                ))
