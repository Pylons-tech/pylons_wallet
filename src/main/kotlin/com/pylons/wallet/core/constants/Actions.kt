...
class Actions {
    companion object {
        ...
        const val BATCH_CREATE_RECIPE = "BATCH_CREATE_RECIPE"
        const val BATCH_UPDATE_RECIPE = "BATCH_UPDATE_RECIPE"
        const val ENABLE_RECIPE = "ENABLE_RECIPE"
        const val DISABLE_RECIPE = "DISABLE_RECIPE"
        const val BATCH_ENABLE_RECIPE = "BATCH_ENABLE_RECIPE"
        const val BATCH_DISABLE_RECIPE = "BATCH_DISABLE_RECIPE"
    }
}